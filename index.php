...
<html lang="en">
  <head>
    <title>Siddhi's Cakery</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Siddhi Rane's Cakery" />
    <meta name="keywords" content="Siddhi Rane, Cakery, Bakery, Cake, Dessert, Cupcake, Brownies, Chocolate, Confectionery" />
    ...
    <div class="site-wrap">
      ...
      <header class="site-header">
        <div class="row align-items-center">
          ...
          <div class="col-2 col-md-6 text-center site-logo-wrap">
            <a href="index.html" class="site-logo">&nbsp;S&nbsp;</a>
          </div>
      ...
      <div class="main-wrap " id="section-home">
        ...
        <div class="cover_1 overlay bg-slant-white bg-light">
          <div class="img_bg" style="background-image: url(images/arranged-art-background.jpg);" data-stellar-background-ratio="0.5">
            <div class="container">
              <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10" data-aos="fade-up">
                  <h2 class="heading mb-5">Welcome to Siddhi's Cakery</h2>
                  <h3 class="sub-heading mb-5">Where food speaks with your palate.</h3>
                  <!-- <p><a href="#section-reservation" class="smoothscroll btn btn-outline-white px-5 py-3">Check Out Menu</a></p> -->
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row section-heading justify-content-center mb-5">
              <div class="col-md-8 text-center">
                <h2 class="heading mb-3">What's bakin'?</h2>
                <!-- <p class="sub-heading mb-5">Few of my best dishes</a></p> -->
              </div>
            </div>
            <div class="row">
              ...
              <div class="ftco-46">
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                  <div class="ftco-46-image" style="background-image: url(images/cup-cake.jpg);"></div>
                  <div class="ftco-46-text ftco-46-arrow-left">
                    <h4 class="ftco-46-subheading">Cup Cakes</h4>
                    <h3 class="ftco-46-heading">lorem ipsum</h3>
                  ...
                  <div class="ftco-46-image" style="background-image: url(images/cake.jpg);"></div>
                </div>

                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                  <div class="ftco-46-text ftco-46-arrow-right">
                    <h4 class="ftco-46-subheading">Brownies</h4>
                    <h3 class="ftco-46-heading">consectetur elit</h3>
                    <p class="mb-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                    <!-- <p><a href="#" class="btn-link">Learn More <span class="ion-android-arrow-forward"></span></a></p> -->
                  </div>
                  <div class="ftco-46-image" style="background-image: url(images/brownie.jpg);"></div>
                  <div class="ftco-46-text ftco-46-arrow-up">
                    <h4 class="ftco-46-subheading">Birthday Cakes</h4>
                    <h3 class="ftco-46-heading">dolore magna</h3>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-12 col-lg-8 section-heading">
                <h2 class="heading mb-5">Why I bake.</h2>
        ...
        <div class="section bg-white pt-2 pb-2 text-center" data-aos="fade">
          <p><img src="images/passion-collage.png" alt="Free Website Template for Restaurants by Free-Template.co" class="img-fluid"></p>
        </div> <!-- .section -->
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-12 section-heading text-center">
                <h2 class="heading mb-5">Meet The Baker</h2>
              </div>
            </div>
            <div class="row">
                ...
                <div class="ftco-38">
                  <div class="ftco-38-img">
                    <div class="ftco-38-header">
                      <img src="images/siddhi.jpg" alt="Free Website Template for Restaurants by Free-Template.co">
                      <h3 class="ftco-38-heading">Siddhi Rane</h3>
        ...
        <!-- <div class="section bg-light" data-aos="fade-up" id="section-reservation">
          ...
          <div class="container">
            <div class="row section-heading justify-content-center mb-5">
              <div class="col-md-8 text-center">
                <h2 class="heading mb-3">Testimonials</h2>
              </div>
            </div>
          ...
          <div class="container">
            ...
            <div class="col-md-4 mb-5">
              <div class="footer-widget">
                <h3 class="mb-4">About Siddhi's Cakery</h3>
            ...
            <div class="col-md-4 mb-5">
              <div class="footer-widget">
                ...
                <p>Devious Semikoli</p>
                <h3 class="mb-4">Contact</h3>
                <p><i class="fa fa-phone"></i> <i class="fa fa-whatsapp"> </i> 8830718940</p>
              </div>
            </div>
